...
pub const TIOCTIMESTAMP = @compileError("unable to translate macro: undefined identifier `timeval`");
// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:156:9
pub const TIOCDCDTIMESTAMP = @compileError("unable to translate macro: undefined identifier `timeval`");
// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:158:9
