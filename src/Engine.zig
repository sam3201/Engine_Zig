...
pub const Camera = struct {
    ...
    pub fn centerOn(self: *Camera, player_x: i32, player_y: i32, world_width: i32, world_height: i32) void {
        ...
        if (self.y + self.height > world_height) self.y = world_height - self.height;
    }
};
