...
pub const Chunk = struct {
    ...
    pub fn init(coord: ?ChunkCoord else ChunkCoord{ .x = 0, .y = 0 }, biome: BiomeType, difficulty_level: i32, allocator: std.mem.Allocator) !Chunk {
        var self = Chunk{
            .coord = coord,
            .biome = biome,
            ...
            .generated = true,
            .items = std.ArrayList(WorldItem.init(coord.x, coord.y, allocator)),
        };
