...
pub const GameServer = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !GameServer {
        ...
        var world_manager = try WorldManager.WorldManager.init(WorldManager.Chunk.ChunkCoord{ .x = 0, .y = 0 }, 0, allocator, &canvas, host_player);
    ...
    fn handleClient(self: *GameServer, connection: net.Server.Connection) !void {
        ...
        const new_player = PlayerModule.createArrowPlayer(self.allocator, 30, 15) catch {
