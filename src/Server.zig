...
pub const GameServer = struct {
    ...
    fn handleClient(self: *GameServer, connection: net.Server.Connection) !void {
        ...
        var writer_buffer_stream = std.io.fixedBufferStream(&writer_buffer);
        var writer = writer_buffer_stream.writer();
        ...
        const new_player = Player.createArrowPlayer(self.allocator, 30, 15) catch {
